@echo off
echo ==========================================
echo    KodnestCareers GitHub Publisher Tool
echo ==========================================
...
git commit -m "Initial commit of KodnestCareers"
...
git remote add origin https://github.com/kiran2304/KodnestCareers.git 2>nul
git remote set-url origin https://github.com/kiran2304/KodnestCareers.git
